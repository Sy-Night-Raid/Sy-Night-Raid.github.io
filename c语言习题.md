...
## 0xD 数组作为函数参数的应用
* 问题描述：10个小孩围成一圈分糖果。首先，老师分给第1个小孩10块，第2个小孩2块，第3个小孩8块，第4个小孩22块，第5个小孩16块，第6个小孩4块，第7个小孩10块，第8个小孩6块，第9个小孩14块，第10个小孩20块。然后按如下方法将每个小孩手中的糖果进行调整：所有的小孩检查自己手中的糖块数，如果糖块数为奇数，则向老师再要一块，再同时将自己手中的糖分一半给下一个小孩（最后一个给第1个）。请问进行多少次调整每个小孩手中的糖块数都相等？各有多少块糖？
